...
def transform_data(data):
    ...
    for item in data:
        ...
        try:
            original_completion_date = datetime.strptime(
                original_completion_date_str, "%d-%b"
            )
            original_completion_date = original_completion_date.replace(
        ...
        if original_completion_date:
            ...
            current_completion_date = original_completion_date + timedelta(
        ...
        project = {
            ...
            "original_completion_date": (
                original_completion_date.strftime("%Y-%m-%d")
                if original_completion_date
                else "Unknown"
            ),
            "current_completion_date": (
                current_completion_date.strftime("%Y-%m-%d")
